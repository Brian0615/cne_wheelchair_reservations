...
from common.data_models import Rental, NewRental, RentalSummary
...
#     """Complete a rental"""
#     return db_service.complete_rental(completed_rental=completed_rental)
...
def get_rentals_on_date(
    ...
    return [Rental(**x) for x in rentals]
