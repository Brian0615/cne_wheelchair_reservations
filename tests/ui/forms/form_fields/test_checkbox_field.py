...
class TestCheckboxField(BaseTestCases.BaseFormFieldTest):
    """Test the Checkbox Field"""

    def setUp(self):
        self.field_class = CheckboxField
        self.expected_init_value = False

    def test_initialize_field(self):
        """Test initializing a new multi-select Field"""
